# davismcc/nf-hipsci-fibro: Reference Genomes Configuration

The davismcc/nf-hipsci-fibro pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```nextflow
includeConfig '/path/to/davismcc/nf-hipsci-fibro/conf/igenomes.config'
```
