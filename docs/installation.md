# davismcc/nf-hipsci-fibro Installation

To start using the davismcc/nf-hipsci-fibro pipeline, there are three steps described below:
...
This pipeline itself needs no installation - NextFlow will automatically fetch it from GitHub if `davismcc/nf-hipsci-fibro` is specified as the pipeline name.
...
```bash
wget https://github.com/davismcc/nf-hipsci-fibro/archive/master.zip
unzip master.zip -d /my-pipelines/
cd /my_data/
nextflow run /my-pipelines/davismcc-nf-hipsci-fibro-master
```
