...
data_dir=${data_path}/davismcc/nf-hipsci-fibro_test_set
...
then
    ...
    curl https://your_website.com/davismcc/nf-hipsci-fibro_test_set.tar.bz2 > ${data_path}/davismcc/nf-hipsci-fibro_test_set.tar.bz2
    echo "Unpacking test set..."
    tar xvjf ${data_path}/davismcc/nf-hipsci-fibro_test_set.tar.bz2 -C ${data_path}
    echo "Done"
fi

# Run name
run_name="Test davismcc/nf-hipsci-fibro Run: "$(date +%s)
